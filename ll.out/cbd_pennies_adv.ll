; ModuleID = 'C-Programming-Examples/cbd_pennies_adv.c'
...
@.str10 = private unnamed_addr constant [38 x i8] c"The value of your %d coins is $%.2f.\0A\00", align 1
...
define i32 @main() #0 {
  ...
  %42 = load i32* %coins, align 4
  %43 = load float* %total, align 4
  %44 = fpext float %43 to double
  %45 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([38 x i8]* @.str10, i32 0, i32 0), i32 %42, double %44)
  ret i32 0
}
