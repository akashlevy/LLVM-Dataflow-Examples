; ModuleID = 'C-Programming-Examples/ex_1-4.c'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@.str = private unnamed_addr constant [13 x i8] c"%6.1f %6.1f\0A\00", align 1
...
define i32 @main() #0 {
  ...
  store float %3, float* %celsius, align 4
  br label %4

; <label>:4                                       ; preds = %9, %0
  %5 = load float* %celsius, align 4
...
; <label>:9                                       ; preds = %4
  %10 = load float* %celsius, align 4
  %11 = fpext float %10 to double
  %12 = fmul double %11, 1.800000e+00
  %13 = fadd double %12, 3.200000e+01
  %14 = fptrunc double %13 to float
  store float %14, float* %fahr, align 4
  %15 = load float* %celsius, align 4
  ...
  %20 = load float* %celsius, align 4
  %21 = load i32* %step, align 4
  %22 = sitofp i32 %21 to float
  %23 = fadd float %20, %22
  store float %23, float* %celsius, align 4
  br label %4
